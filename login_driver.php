...
if (isset($_POST['loginDriver'])) {
    ...
    if (isset($_POST["dr_email"]) && isset($_POST["dr_password"])) {
        ...
        if ($email == "admin@admin.com" && $password == "admin1234.") {
            ...
            $query = "SELECT * FROM delivery_driver WHERE dr_email = '$email'";
            $result = mysqli_query($con, $query);

            $row = mysqli_fetch_array($result);

            if ($row && password_verify($password, $row['dr_password'])) {
            ...
            <div class="form-content" id="LoginDriver">
                ...
                <form action="login_driver.php" method="POST">
                    <div class="field input-field">
                        <input type="email" id="email" name="dr_email" placeholder="Enter Email" aria-describedby="emailHelp" required>
                    </div>
                    <div class="field input-field">
                        <input type="password" id="password" name="dr_password" placeholder="Enter Password" required>
                ...
                <div class="form-link">
                    <span>คุณยังไม่ได้สมัครสมาชิกใช่หรือไม่?<a href="register_driver.php" class="link signup-link">Signup</a></span>
                </div>
            </div>
            <div class="line"></div>
